  ...
  $.fn.resetAutosize = function(options){
	...
	$.fn.addTag = function(value,options) {
			...
			this.each(function() { 
				...
				if (options.unique) {
					var validURL = /[a-z0-9\-\.]{2,}\.[a-z]{2,4}$/.test(value);
					var skipTag = $(this).tagExist(value);
					if(value.localeCompare('getcoldturkey.com') == 0 || value.localeCompare('pool.ntp.org') == 0){
						skipTag = true;
					}
					if(skipTag == true || validURL == false) {
				...
				if (value !='' && skipTag != true && validURL != false) { 
